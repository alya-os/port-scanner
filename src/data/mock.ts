...
function record(
  overrides: Partial<PortRecord> & Pick<PortRecord, "id" | "port" | "processName" | "groupName" | "identification">,
): PortRecord {
  return {
    protocol: "TCP",
...
const brandtrackerDirectory = "/Users/jp/Documents/Dev/Projet/IndexWebMarketing/interne/2025/alya-genai-brandtracker";

export const mockScan: ScanResult = {
  scannedAt: now,
  platform: "macos",
  permissionLimited: true,
  warnings: ["3 sockets système sont visibles sans PID. Les permissions peuvent masquer leur propriétaire."],
  records: [
    ...[5304, 5305, 5306, 5307, 5308].map((port, index) =>
      record({
        ...
        processPath: `${brandtrackerDirectory}/.venv/bin/python`,
        command: index === 0 ? ".venv/bin/python scratchpad/run_gaio.py" : `.venv/bin/python -m uvicorn app.main:app --port ${port}`,
        workingDirectory: brandtrackerDirectory,
        startedAt: now - (index === 0 ? 6 * 86_400 : 3 * 86_400) - index * 4000,
        uptimeSeconds: (index === 0 ? 6 * 86_400 : 3 * 86_400) + index * 4000,
    ...
    record({
      ...
      workingDirectory: "/Users/jp/Documents/Dev/Projet/Perso/portfolio/2026/LifeBudget",
      uptimeSeconds: 680,
      startedAt: now - 680,
      cpuUsage: 3.4,
      activeConnections: 2,
    ...
    ...[80, 443].map((port) =>
      record({
        ...
        localAddress: "0.0.0.0",
        scope: "network",
        processPath: "/Users/jp/Library/Application Support/Local/lightning-services/nginx/sbin/nginx",
    ...
    ...[10000, 10001].map((port) =>
      record({
        ...
        localAddress: "0.0.0.0",
        scope: "network",
        processPath: "/Users/jp/Library/Application Support/Local/lightning-services/mailpit/bin/mailpit",
        uptimeSeconds: 31 * 86_400,
        startedAt: now - 31 * 86_400,
      }),
    ),
    record({
      ...
      protected: true,
      protectionReasons: ["Service du système protégé par défaut", "SSH"],
    }),
    record({
      id: "system-53",
      port: 53,
      ...
      protected: true,
      protectionReasons: ["Service du système protégé par défaut", "DNS et découverte locale"],
    }),
    ...[5000, 7000].map((port) =>
      record({
        ...
        protected: true,
        protectionReasons: ["Service du système protégé par défaut"],
      }),
    ),
  ],
};
...
export const mockSettings: AppSettings = {
  ...
  rules: [
    ...
    { id: "process-launchd", label: "launchd", kind: "process", value: "launchd", enabled: true, builtin: true },
    { id: "process-mdns", label: "mDNSResponder", kind: "process", value: "mDNSResponder", enabled: true, builtin: true },
    { id: "path-system", label: "Chemin système", kind: "path", value: "/System/Library/", enabled: true, builtin: true },
  ],
};
