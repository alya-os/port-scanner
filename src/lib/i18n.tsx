...
const fr = {
  ...
  "tree.processCount": "{count} processus",
  ...
  "tree.connection": "{count} connexion",
  "tree.connections": "{count} connexions",
  ...
  "inspector.connections": "{count} connexion(s)",
  ...
  "inspector.stopDescription": "Fermera {count} port(s) et les connexions associées.",
  ...
  "kill.description": "Cette action demandera l’arrêt de {processes} processus et fermera {ports} port(s). Les connexions actives seront interrompues.",
  "kill.folder": "Dossier",
  ...
  "status.processes": "{count} processus",
  "status.ports": "{count} ports",
  ...
  "toast.processStopped": "{count} processus arrêté(s).",
...
const en: Record<TranslationKey, string> = {
  ...
  "inspector.connections": "{count} connection(s)",
  ...
  "inspector.stopDescription": "Closes {count} port(s) and their associated connections.",
  "inspector.stopBlocked": "Stop blocked",
  "inspector.stopProcesses": "Stop {count} processes",
  "inspector.stop": "Stop",
  "kill.close": "Close",
  "kill.title": "Stop {name}?",
  "kill.description": "This action will request that {processes} processes stop and will close {ports} port(s). Active connections will be interrupted.",
  "kill.folder": "Folder",
  ...
  "toast.processStopped": "{count} process(es) stopped.",
